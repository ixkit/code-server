...
export class FolderApiWidget extends ReactWidget {
    ...
    protected async doInit(): Promise <void> {
        this.id = FolderApiWidget.ID;
        this.title.label = FolderApiWidget.LABEL;
        this.title.caption = FolderApiWidget.LABEL;
    ...
    protected displayMessage(): void {
        this.messageService.info('Congratulations: FolderApi Widget Successfully Created!');
    }
